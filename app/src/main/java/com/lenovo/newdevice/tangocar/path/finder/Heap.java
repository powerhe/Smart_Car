...
public class Heap<T extends Comparable<? super T>> {
     ...
     *
     * @param isMaxHeap Whether the heap is a maximum heap
     */
     ...
     * already heapified.
     *
     * @param copy The heap to be copied
     */
     ...
     *
     * @param addition The element to be added to the heap
     */
     ...
     *
     * @param i Node at which to start heapification
     */
